...
const faqConfig = {
  ...
  methods: {
    ...
    update: 'updateFaq',
    delete: 'deleteFaq',
    deleteFaqsBulk: 'deleteFaqsBulk',
  },
  titleKey: 'nav-faqs',
  addKey: 'add-faq-text',
  nameColumn: 'question_ar',
  fields: [
    ...
    { name: 'order_index', type: 'number', labelEn: 'Order', labelAr: 'الترتيب', default: 0 },
    { name: 'is_active', type: 'checkbox', labelEn: 'Active', labelAr: 'نشط', default: true },
  ],
  columns: [
    { key: 'question_ar', type: 'text', headerEn: 'Question (AR)', headerAr: 'السؤال' },
    { key: 'order_index', type: 'text', headerEn: 'Order', headerAr: 'الترتيب' },
...
const packageConfigFitness = {
  ...
  fields: [
    ...
    { name: 'level', type: 'select', labelEn: 'Level', labelAr: 'المستوى', options: ['beginner', 'intermediate', 'advanced', 'elite'], default: 'beginner' },
    { name: 'type', type: 'select', labelEn: 'Type', labelAr: 'النوع', options: ['training', 'nutrition', 'combined'], default: 'combined' },
