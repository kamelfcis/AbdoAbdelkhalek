...
import { AccessPanelToolbar, VideoAccessRow } from '../modalHelpers';
...
const VideoAccessPanel = ({
  ...
  return (
    <section aria-label={tr('trainee-access-videos-section')} data-testid="video-access-panel">
      <h3 className="mb-3 font-semibold text-[var(--color-text)]">
        {tr('trainee-access-videos-section')}
      </h3>
      <AccessPanelToolbar
      ...
      {visibleVideos.length === 0 ? (
        ...
        <>
          ...
          <div
            ref={parentRef}
            className="max-h-[52vh] min-h-[320px] overflow-y-auto pe-1"
            style={{ height: '320px' }}
            data-testid="video-virtual-list"
          >
            {usePlainList ? (
