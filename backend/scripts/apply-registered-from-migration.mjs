...
const migPath = join(
  root,
  'backend/prisma/migrations/20260605120000_user_registered_from/migration.sql'
);
...
const before = await query(
  `SELECT column_name FROM information_schema.columns WHERE table_schema='public' AND table_name='users' AND column_name='registered_from'`
);
